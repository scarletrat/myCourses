...
# Spring 2025
Embedded Systems: Programming ZYBO Z7 FPGA board using VHDL on Xilinx Vivado. The Zynq-7000 tightly integrates a dual-core ARM Cortex-A9 processor with Xilinx 7-series Field Programmable Gate Array (FPGA) logic. 
Used a UART Pmod to send characters from the board to the terminal. Display image pixels from an image stored in the board to the desktop using a vga connector.
